...
git clone https://github.com/olzhas0986-dev/rik_xiaomi_munch device/xiaomi/munch; \
git clone https://github.com/olzhas0986-dev/rik_xiaomi_sm8250_common device/xiaomi/sm8250-common; \
...
git clone https://github.com/olzhas0986-dev/n0_xiaomi_sm8250 kernel/xiaomi/sm8250; \
