...
git clone https://github.com/Olzhasyx/device_xiaomi_munch.git device/xiaomi/munch; \
git clone https://github.com/Olzhasyx/device_xiaomi_sm8250-common device/xiaomi/sm8250-common; \
...
git clone https://github.com/Olzhasyx/kernel_xiaomi_sm8250-hd.git -b ksu-susfs kernel/xiaomi/sm8250; \
