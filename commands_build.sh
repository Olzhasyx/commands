...
git clone https://github.com/Olzhasyx/d-x-m device/xiaomi/munch; \
git clone https://github.com/Olzhasyx/android_device_xiaomi_sm8250 device/xiaomi/sm8250-common; \
...
. build/envsetup.sh; \
lunch aosp_munch-bp1a-user && mka bacon
#brunch munch
