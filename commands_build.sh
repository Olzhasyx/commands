...
git clone https://github.com/Olzhasyx/android_device_xiaomi_sm8250-common device/xiaomi/sm8250-common; \
...
git clone https://github.com/Efeisot/android_vendor_xiaomi_sm8250-common vendor/xiaomi/sm8250-common; \
